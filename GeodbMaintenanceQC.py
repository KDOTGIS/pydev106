...
def Analyze():
    ...
    AnalyzeDatasets_management(rh, "NO_SYSTEM", "KhubSourceNet.RH.Calibration_Point;KhubSourceNet.RH.Centerline;KhubSourceNet.RH.Centerline_Sequence;KhubSourceNet.RH.Lrs_Edit_Log;KhubSourceNet.RH.Lrs_Event_Behavior;KhubSourceNet.RH.Lrs_Locks;KhubSourceNet.RH.Lrs_Metadata;KhubSourceNet.RH.Redline;KhubSourceNet.RH.SourceRoutes", "ANALYZE_BASE", "ANALYZE_DELTA", "ANALYZE_ARCHIVE")
