...
def PublicateNetworkProd2Target(target):
    ...
    from arcpy import (da, CopyFeatures_management, ChangePrivileges_management, AddMessage, MakeFeatureLayer_management, AddWarning, Project_management, TruncateTable_management, Append_management, 
...
def CreatePrimaryNetwork(target):
    ...
    from arcpy import (env, da, CreateFileGDB_management, AddMessage, AddWarning, Exists, MakeRouteEventLayer_lr, 
    ...
    CreateTable_management, Append_management, AddField_management, CalculateField_management, TableToTable_conversion)
    from datetime import datetime
